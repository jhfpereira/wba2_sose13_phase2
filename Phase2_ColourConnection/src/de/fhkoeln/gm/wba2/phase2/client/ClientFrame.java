...
public class ClientFrame extends JFrame {
    ...
    public ClientFrame(ConnectionFrame parent) {
            ...
            public void valueChanged(ListSelectionEvent e) {
                ...
                if(index >= 0) {
                    ...
                    if(c != null) {
                        ...
                        /* show colour */
                        colour_view.setBackground(new Color(cw.getRed(), cw.getGreen(), cw.getBlue()));
                        ...
                        /* show date of creation */
                        outColourCreated.setText(getFormattedDate(c.getDateOfCreation()));
                    }
                }
            }
        });
        ...
        all_colourpalettes.addListSelectionListener(new ListSelectionListener() {
        ...
        btnToPalette.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if(index >= 0) {
                    ...
                    Color new_c = new Color(cw.getRed(), cw.getGreen(), cw.getBlue());
            ...
            public void actionPerformed(ActionEvent arg) {
                ...
                if(show_mode_colour) {
                    ...
                    if(mode == "explore") {
                        ...
                        if(index >= 0) {
                            String cpid = colourpaletteList.get(index).getId().toString();
                        ...
                        if(index >= 0) {
                            String cpid = creationsList.get(index).getId().toString();
        ...
        btnUnFavResource.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg) {
                ...
                if(show_mode_colour) {
                    ...
                    if(index >= 0) {
                        String cpid = favColourpaletteList.get(index).getId().toString();
            ...
            public void actionPerformed(ActionEvent arg) {
                ...
                if(show_mode_colour) {
                    ...
                    if(mode == "explore") {
                        ...
                        if(index >= 0) {
                            u = rch.getCreatorOfColourpalette(colourpaletteList.get(index));
                        }
                    }
                    else if(mode == "creations") {
                        ...
                        if(index >= 0 ) {
                            u = rch.getCreatorOfColourpalette(userList.get(index));
                        }
                    }
                }
        ...
        btnUnFollowUser.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg) {
                ...
                if(show_mode_colour) {
                    ...
                    if(index >= 0) {
                        u = rch.getCreatorOfColourpalette(favColourpaletteList.get(index));
                    }
                }
        ...
        red_slider.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent arg) {
                ...
                create_colour_view.setBackground(new Color(create_colour_val[0], create_colour_val[1], create_colour_val[2]));
            }
        });
        ...
        btnCreateColour.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg) {
                ColourWrapper cw = new ColourWrapper(create_colour_val[0], create_colour_val[1], create_colour_val[2]);
        ...
        btnAddColour.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg) {
                ...
                String c_code = new ColourWrapper(create_colour_val[0], create_colour_val[1], create_colour_val[2]).getHexCode();
                ...
                Color new_c = new Color(create_colour_val[0], create_colour_val[1], create_colour_val[2]);
        ...
        btnResetColourpalette.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                for(int i = 0; i < create_colourpalette_view.length; i++) {
                    create_colourpalette_view[i].setBackground(contentPane.getBackground());
                }
            }
        });
        ...
        all_favcolourpalettes.addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent arg) {
                ...
                if(index >= 0) {
                    ...
                    if(cp != null) {
                        ...
                        outColourCreator.setText((String)cb_creations_user.getItemAt(index_user));
            ...
            public void valueChanged(ListSelectionEvent arg) {
                ...
                if(index >= 0) {
                    ...
                    if(u != null) {
                        ...
                        outFolgerRegistriertAm.setText(getFormattedDate(u.getDateOfRegistration()));
                        outFolgerRegistriertAm.setVisible(true);
                        
                        lblFolgerSeit.setVisible(true);
                        outFolgerSeit.setText(getFormattedDate(f.getFollowingSince()));
            ...
            public void actionPerformed(ActionEvent arg) {
                ...
                if(index >= 0) {
                    ...
                    if(u != null) {
                        ...
                        /* show date of creation */
                        outBenutzerRegistiertAm.setText(getFormattedDate(u.getDateOfRegistration()));
    ...
    private String getFormattedDate(XMLGregorianCalendar xgc) {
        ...
        String date =   ((xgc.getDay() < 10) ? "0" + xgc.getDay(): xgc.getDay()) + "." +
                        ((xgc.getMonth() < 10) ? "0" + xgc.getMonth(): xgc.getMonth()) +"." +
                        xgc.getYear() + " - " +
                        ((xgc.getHour() < 10) ? "0" + xgc.getHour(): xgc.getHour()) + ":" +
                        ((xgc.getMinute() < 10) ? "0" + xgc.getMinute(): xgc.getMinute());
        return date;
    }
    
    
    public void setConnectionHandlers(ConnectionHandler ch, RESTConnectionHandler rch) {
        this.ch = ch;
        this.rch = rch;
